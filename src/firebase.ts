...
// Use memory-only local cache to prevent data from being written to IndexedDB
// This addresses the security concern of exposing all data in DevTools Application tab.
