...
export default function PrivacyPolicy({ onBack }: PrivacyPolicyProps) {
  ...
  return (
    <div id="privacy-policy-view" className="min-h-screen bg-white dark:bg-[#070709] text-[#1E293B] dark:text-[#E2E8F0] font-sans antialiased selection:bg-amber-400/20 selection:text-amber-500">
