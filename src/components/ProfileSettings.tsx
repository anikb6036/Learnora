                ...
                <form onSubmit={handleChangePassword} className="space-y-4">
                  ...
                  <div className="pt-4 flex flex-col sm:flex-row justify-between items-center gap-3">
                    <button
                      ...
                      className="text-xs text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300 font-semibold cursor-pointer select-none hover:underline flex items-center gap-1.5"
                    >
                      Forgot password?
                    </button>
            ...
            {forgotSuccess ? (
              ...
              <form 
                onSubmit={(e) => {
                  ...
                  const matchedUser = listToSearch.find(u => u && u.email && u.email.toLowerCase() === targetEmail);
                  ...
                  if (matchedUser) {
                    ...
                    setForgotError('Please input register mail id.');
                  }
                }}
                className="space-y-4"
              >
