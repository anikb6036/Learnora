                    ...
                    <button
                      ...
                      className={`w-full text-left py-3.5 px-3.5 rounded-2xl transition flex flex-col gap-1 cursor-pointer border ${
                        selectedMailId === mail.id
                          ? 'bg-slate-100/80 dark:bg-white/10 border-slate-200 dark:border-white/10'
                          : 'bg-transparent border-transparent hover:bg-slate-50 dark:hover:bg-white/5'
                      }`}
                    >
                      <div className="flex justify-between items-center mb-0.5">
                        <span className="text-xs text-slate-700 dark:text-gray-300 font-normal max-w-[70%] truncate">
                      ...
                      <p className="text-xs font-normal leading-snug truncate text-slate-800 dark:text-gray-200">
                        {mail.subject}
                      </p>
                      <p className="text-[11px] text-slate-500 dark:text-gray-400 truncate mt-0.5 font-normal">
                        {mail.body}
                      </p>
                    </button>
                  ))}
                  ...
                  <div className="p-4.5 rounded-2xl bg-slate-50 dark:bg-[#0F0F11] border border-slate-100 dark:border-white/5 space-y-3 relative overflow-hidden">
                    ...
                    <div className="flex justify-between items-start border-b border-slate-150 dark:border-white/5 pb-2.5 text-xs gap-4">
                      <div className="space-y-0.5 truncate">
                        <p className="truncate"><span className="text-slate-400 dark:text-gray-500 text-[10px] font-normal">FROM:</span> <span className="text-slate-800 dark:text-gray-200 font-normal">{selectedMail.from}</span></p>
                        <p className="truncate"><span className="text-slate-400 dark:text-gray-500 text-[10px] font-normal">TO:</span> <span className="text-slate-800 dark:text-gray-200 font-normal">{selectedMail.to}</span></p>
                      </div>
                      <span className="text-[10px] text-slate-400 whitespace-nowrap pt-0.5 font-normal">
                    ...
                    <h4 className="text-sm font-normal text-slate-800 dark:text-gray-200 leading-snug">{selectedMail.subject}</h4>
                  </div>
