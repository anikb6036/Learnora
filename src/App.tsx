                  ...
                  <div className="space-y-4">
                      ...
                      <div className="mb-6">
                        ...
                        <p className="text-[13px] text-slate-500 dark:text-gray-400 leading-relaxed font-sans mt-2">
                          {admissionMethod === 'selection' 
                            ? 'Begin your admission process. Choose a secure account sign-in method below to instantly pre-populate your student details, or proceed manually.' 
                    ...
                    {fastRegSuccess ? (
                      ...
                      <>
                        ...
                        {admissionMethod === 'google-login' && (
                          <div className="space-y-6 animate-fadeIn max-w-sm mx-auto bg-white dark:bg-[#1a1a1e] p-6 rounded-2xl border border-slate-200 dark:border-white/5 shadow-md">
                            {/* Google Logo / Brand */}
                            <div className="flex flex-col items-center text-center space-y-2 pb-2">
                              <div className="flex gap-1 items-center justify-center font-bold text-lg tracking-tight font-sans">
                                <span className="text-blue-500 text-xl font-black">G</span>
                                <span className="text-red-500 text-xl font-black">o</span>
                                <span className="text-yellow-500 text-xl font-black">o</span>
                                <span className="text-blue-500 text-xl font-black">g</span>
                                <span className="text-green-500 text-xl font-black">l</span>
                                <span className="text-red-500 text-xl font-black">e</span>
                              </div>
                              <h4 className="text-base font-bold text-slate-800 dark:text-white">Secure Identity Sync</h4>
                              <p className="text-xs text-slate-500 dark:text-gray-400">Connect your real Google account to continue to Learnora Admissions</p>
                            </div>

                            {googleError && (
                              <div className={`p-4 border rounded-xl text-xs leading-relaxed ${
                                isDomainError
                                  ? 'bg-red-50 dark:bg-red-950/20 border-red-200 dark:border-red-500/30 text-slate-800 dark:text-gray-350 font-normal'
                                  : isPopupError
                                  ...
                                  : 'bg-red-50 dark:bg-red-500/10 border-red-200 dark:border-red-500/20 text-red-600 dark:text-red-400 font-semibold'
                              }`}>
                                {isDomainError ? (
                                  <div className="space-y-3 text-left">
                                    <div className="flex gap-2.5 items-start">
                                      ...
                                      <div>
                                        <span className="font-bold text-red-600 dark:text-red-400 block mb-1">Firebase Domain Authorization Required</span>
                                        <p className="text-slate-600 dark:text-gray-450 leading-relaxed font-sans">
                                          Your Firebase app is rejecting auth requests from <strong className="text-slate-800 dark:text-white">learnora.in</strong> because it hasn't been added to your authorized domains.
                                        </p>
                                      </div>
                                    </div>
                                    
                                    <div className="p-3 bg-white dark:bg-[#111115] rounded-lg border border-slate-200 dark:border-white/5 space-y-2">
                                      <span className="text-[10px] uppercase font-bold text-slate-500 dark:text-gray-400 tracking-wider block font-mono">How to resolve:</span>
                                      <ol className="list-decimal pl-4 space-y-1.5 text-slate-600 dark:text-gray-400 text-[11px] font-sans">
                                        <li>Open your <a href="https://console.firebase.google.com/" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline font-bold inline-flex items-center gap-0.5">Firebase Console ↗</a></li>
                                        <li>Navigate to <strong>Authentication &rarr; Settings &rarr; Authorized domains</strong></li>
                                        <li>Click <strong>Add domain</strong> and enter:
                                          <div className="mt-1 flex items-center justify-between bg-slate-50 dark:bg-black/40 px-2 py-1 rounded border border-slate-200 dark:border-[#30363d] font-mono text-[11px] text-amber-600 dark:text-amber-400">
                                            <span>learnora.in</span>
                                            <button 
                                              type="button"
                                              onClick={(e) => {
                                                e.stopPropagation();
                                                navigator.clipboard.writeText('learnora.in');
                                                triggerToast({
                                                  id: generateUniqueId('notif'),
                                                  title: 'Copied to Clipboard',
                                                  message: 'learnora.in has been copied.',
                                                  timestamp: new Date().toISOString(),
                                                  read: false,
                                                  type: 'general',
                                                  channel: 'system'
                                              ...
                                              className="text-[10px] text-blue-500 hover:text-blue-600 font-sans font-bold uppercase tracking-wider px-1 cursor-pointer"
                                            >
                                              Copy
                                            </button>
                                          </div>
                                    ...
                                    <div className="text-[10px] text-slate-500 dark:text-gray-450 leading-relaxed font-sans">
                                      💡 <strong>No downtime fallback:</strong> Use our secure, instant <strong>Iframe Fallback</strong> form below to sync your Google email address and proceed instantly!
                                    </div>
                                  </div>
                                ) : isPopupError ? (
                            ...
                            <div className="space-y-4">
                              <p className="text-xs text-slate-550 dark:text-slate-400 leading-relaxed text-center font-sans">
                                Firebase will securely authenticate you. Google will share your verified name, email address, and profile picture to instantly populate your student profile.
                              </p>
                              ...
                              <button
                                ...
                                onClick={handleGoogleSignIn}
                                className="w-full py-3 px-4 bg-white hover:bg-slate-50 dark:bg-[#0f0f11] dark:hover:bg-white/5 text-slate-800 dark:text-white font-bold text-xs rounded-xl border border-slate-200 dark:border-white/10 shadow-sm transition-all flex items-center justify-center gap-3 active:scale-95 cursor-pointer disabled:opacity-50"
                              >
                                {googleLoading ? (
                                  <>
                              ...
                              {/* Iframe Safe Fallback Option */}
                              <div className="relative flex items-center justify-center py-2">
                                <div className="absolute inset-0 flex items-center">
                                  <div className="w-full border-t border-slate-200 dark:border-white/10"></div>
                                </div>
                                <span className="relative px-3 text-[10px] uppercase font-bold text-slate-400 dark:text-gray-500 bg-white dark:bg-[#1a1a1e] tracking-wider font-mono">
                                  Or Iframe Fallback
                                </span>
                              </div>

                              <div id="iframe-fallback-section" className={`space-y-3 p-4 rounded-xl text-left border transition-all duration-500 ${
                                isPopupError || isDomainError
                                  ? 'bg-amber-500/10 dark:bg-amber-500/5 border-amber-500/80 shadow-md shadow-amber-500/5 ring-1 ring-amber-500/50' 
                                  : 'bg-slate-50 dark:bg-black/20 border-slate-200/50 dark:border-white/5'
                              }`}>
                                <p className="text-[10px] text-slate-500 dark:text-gray-400 leading-relaxed font-sans">
                                  If your browser blocks popup windows in the embedded preview, you can enter your Google account email below to bypass the form and instantly proceed to course selection.
                                </p>
                                <div className="space-y-1">
                                  <label className="text-[10px] font-bold text-slate-550 dark:text-gray-400 block uppercase tracking-wider font-mono">Google Email Address</label>
                                  <input
                                    type="email"
                                    value={googleEmail}
                                    onChange={e => {
                                    ...
                                    placeholder="e.g. baidyaanik18@gmail.com"
                                    className={`w-full px-3 py-2 text-xs bg-white dark:bg-[#0d1117] rounded-md border focus:outline-none text-slate-800 dark:text-white font-sans placeholder-gray-400 transition-colors ${
                                      isPopupError || isDomainError ? 'border-amber-500 focus:border-amber-600' : 'border-slate-200 dark:border-[#30363d] focus:border-amber-500'
                                    }`}
                                  />
                                </div>
                                <button
                                  ...
                                  onClick={() => {
                                    ...
                                    if (prefix.toLowerCase().includes('anik')) {
                                      first = 'Anik';
                                      last = 'Baidya';
                                    } else if (prefix.includes('.') || prefix.includes('_') || prefix.includes('-')) {
                                    ...
                                    triggerToast({
                                      ...
                                      message: `Synced successfully with ${googleEmail.trim()}`,
                                      timestamp: new Date().toISOString(),
                                      read: false,
                                      type: 'general',
                                      channel: 'system'
                                  ...
                                  className="w-full py-2 bg-amber-500 hover:bg-amber-600 text-amber-950 text-xs font-bold rounded-lg transition-all flex items-center justify-center gap-1.5 cursor-pointer shadow-sm active:scale-[0.98]"
                                >
                                  <Chrome className="w-3.5 h-3.5" />
                                  <span>Sync Google Email & Proceed</span>
                                </button>
                              </div>
                              ...
                              <div className="flex justify-center pt-2">
                                <button
                                  ...
                                  className="text-xs text-slate-500 hover:text-slate-700 dark:hover:text-gray-300 font-bold hover:underline"
                                >
                                  Back to Selection
                                </button>
                              </div>
                          ...
                          <div className="space-y-6 animate-fadeIn max-w-md mx-auto">
                            <div className="text-center space-y-2">
                              ...
                              <p className="text-xs text-slate-550 dark:text-gray-400 font-sans">
                                Complete your admission using your verified connected account details.
                              </p>
                            </div>

                            {/* Social Profile Badge Card */}
                            <div className="p-4 bg-slate-50 dark:bg-[#0c0c0e] rounded-2xl border border-slate-200/60 dark:border-white/5 flex items-center gap-4 shadow-inner relative overflow-hidden">
                              ...
                              <div className="space-y-0.5 min-w-0 flex-1">
                                <div className="flex items-center gap-1.5">
                                  <span className="text-xs font-bold text-slate-800 dark:text-gray-100 font-sans truncate">
                                ...
                                <p className="text-[10px] text-slate-400 dark:text-slate-500 font-mono capitalize">
                                  Connected via {socialProvider}
                                </p>
                              </div>
                            </div>

                            <form onSubmit={handleSocialStudentSubmit} className="space-y-5" noValidate>
                              {/* Course Dropdown */}
                              <div className="space-y-1.5">
                                <label className="text-xs font-semibold text-slate-550 dark:text-gray-400 block mb-1">
                                  Desired Professional Course *
                                </label>
                                <select
                                  required
                                  value={fastCourse}
                                  ...
                                  className={`w-full px-3 py-3 text-xs bg-slate-50 dark:bg-[#070708] rounded-xl border ${
                                    fastCourseError ? 'border-rose-500 ring-1 ring-rose-500' : 'border-slate-200 dark:border-white/5'
                                  } focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 text-slate-855 dark:text-gray-100 transition-all font-sans`}
                                >
                              ...
                              <div className="flex flex-col gap-2.5 pt-2">
                                <button
                                  type="submit"
                                  className="w-full py-3 px-4 bg-amber-500 hover:bg-amber-600 dark:bg-amber-500 dark:hover:bg-amber-600 text-amber-950 font-bold text-xs rounded-xl shadow-md transition-all flex items-center justify-center gap-2 active:scale-95 cursor-pointer font-sans"
                                >
                                ...
                                <button
                                  ...
                                  className="w-full py-2.5 bg-slate-100 hover:bg-slate-200 dark:bg-white/5 dark:hover:bg-white/10 text-slate-700 dark:text-gray-300 font-bold text-xs rounded-xl transition-all active:scale-[0.98] cursor-pointer font-sans"
                                >
                        ...
                        {studentScheduleTab === 'schedule' ? (
                          ...
                          <div className="space-y-6">
                            ...
                            <div className="bg-white dark:bg-slate-900/10 p-6 rounded-2xl border border-slate-200 dark:border-white/5 shadow-sm relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-4">
                              <div className="relative z-10">
                                <div className="flex items-center gap-2 mb-2">
                                  <span className="px-2 py-0.5 bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300 rounded text-[10px] font-bold tracking-wider uppercase">History</span>
                                </div>
                                <h3 className="text-xl font-bold text-slate-900 dark:text-white flex items-center gap-2 font-sans tracking-tight">
                                  Past Completed Classes
                                </h3>
                                <p className="text-xs text-slate-500 dark:text-gray-400 mt-1.5 max-w-xl leading-relaxed">
                                  Review your previously attended sessions and past coursework.
                                </p>
                              </div>
                              <div className="hidden lg:block absolute right-0 top-0 translate-x-4 -translate-y-4 text-slate-50/50 dark:text-slate-800/20 select-none pointer-events-none">
                                ...
                                return completedClasses.map(cl => {
                                  ...
                                  return (
                                    <div key={cl.id} className="grid grid-cols-1 md:grid-cols-12 gap-4 px-6 py-4 bg-white border border-slate-200 rounded-2xl hover:border-slate-300 shadow-sm hover:shadow-md transition-all duration-200 dark:bg-slate-900/10 dark:border-white/5 dark:hover:border-white/10 items-center">
                                      ...
                                      <div className="md:col-span-3">
                                         <span className="inline-flex items-center px-2 py-0.5 rounded border text-[11px] font-bold uppercase tracking-tight bg-slate-50 text-slate-600 border-slate-200 dark:bg-slate-800/50 dark:text-slate-400 dark:border-slate-700">
                                            Completed
                                          </span>
                                      </div>
