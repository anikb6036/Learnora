                                                ...
                                                <div className="md:col-span-5 min-w-0 flex items-center justify-between gap-4">
                                                  <div className="min-w-0">
                                                    ...
                                                    {cl.status === 'cancelled' ? (
                                                      ...
                                                      <div className="flex items-center gap-2 mt-1">
                                                        {isLinkActive ? (
                                                          <a href={cl.location.startsWith('http') ? cl.location : `https://${cl.location}`} target="_blank" rel="noopener noreferrer" className="px-4 py-2 bg-slate-900 hover:bg-slate-800 text-white rounded-lg text-xs font-bold transition flex items-center gap-1.5 shadow-sm hover:-translate-y-0.5 active:translate-y-0 duration-150">
                                                            Join Class
                                                          </a>
                                                        ) : (
                                                          <button disabled className="px-4 py-2 bg-slate-100 text-slate-400 dark:bg-white/5 dark:text-slate-500 rounded-lg text-xs font-bold cursor-not-allowed border border-slate-200 dark:border-white/10">
                                                            Join Class
                                                          </button>
                                                        )}
                                                      </div>
                                                    ) : (
                                                      <p className="text-xs text-slate-500 dark:text-slate-400 truncate mt-1"><span className="opacity-75">Location:</span> {cl.location}</p>
                                                    )}
                                                  </div>
